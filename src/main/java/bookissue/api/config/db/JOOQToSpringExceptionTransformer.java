package bookissue.api.config.db;
 ...
 *       This class â€œselectsâ€? the right DataAccessException by analyzing vendor specific error codes.
 *
 *       ii. If the SQL dialect isnâ€™t found, create a new SQLStateSQLExceptionTranslator object.
 *       This class â€œselectsâ€? the right DataAccessException by analyzing the SQL state stored to the SQLException.
